 ...
 */
 ...
 /**
  * @brief TC10: Odd vs Even Address Double-Byte Read Consistency Test.
  * @note  Tests auto-increment read behavior, parity alignment, and CRC integrity across address boundaries.
  * @param ctx Pointer to test context.
  */
 ...
 /**
  * @brief Dump all 44 registers (0x00 ~ 0x2B) with address, name, hex, binary, and descriptions.
  * @param ctx Pointer to test context.
  */
